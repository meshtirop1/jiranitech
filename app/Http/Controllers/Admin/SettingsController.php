...
class SettingsController extends Controller
{
    ...
    public const FIELDS = [
        ...
        'company_email_security' => ['Security disclosure address', 'Published in the responsible disclosure policy. security@ is the name other operators look for.', 'email'],
        'company_email_careers' => ['Applications address', 'Used by the apply link on each vacancy. Falls back to the enquiries address when empty.', 'email'],
